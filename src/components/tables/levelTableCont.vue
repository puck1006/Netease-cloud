<template>
  <!-- 表格说明： 此表格主要用于表格中存在意向级别图标样式的情况***此表格组件针对向级别图标，同时兼具基本表格的功能：复选框，编辑列，表格列中内容有点击事件-->
  <div class="table-content levelTable" :style="{'height':(tableData.options.tableHeight+'px')}">
    <el-table
      :data="tableData.list"
      border
      fit
