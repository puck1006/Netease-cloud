<template>
  ...
  <!-- 适用于教务系统 小循环登记 -- 补课纪录 -->
  <div
    class="table-content inputTableCont"
        ...
        <template v-if="$index==IndexId || $index==IndexIdTwo ||$index==0">
          ...
          >
            <template slot-scope="scope">
              ...
              >
                <el-option :value="11" :label="$t('Educational.circulateRegistrat.missclassRecord.select[0]')">
                </el-option>
                <el-option :value="22" :label="$t('Educational.circulateRegistrat.missclassRecord.select[1]')">
                </el-option>
                <el-option :value="33" :label="$t('Educational.circulateRegistrat.missclassRecord.select[2]')">
                </el-option>
              </el-select>
