<template>
  <!-- 表格说明： 此表格主要用于表格中有环形进度条显示的情况，同时兼具基本表格的功能：复选框，编辑列，表格列中内容有点击事件-->
  <div
    class="table-content progressAnaularTableCont"
        ...
        <template v-if="$index==IndexId || $index==IndexIdTwo ||$index==0">
          ...
          >
            <template slot-scope="scope">
              <!-- 判断进度条 -->
              <div v-if="column.isProgress" class="progress-au table-progress flex-al ml10">
