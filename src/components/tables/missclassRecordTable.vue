<template>
  ...
  <!-- 适用于教务系统 小循环登记 -- 补课纪录 -->
  <div
    class="table-content missclassRecordTable"
          ...
          >
            <template slot-scope="scope">
              ...
              <el-select
                ...
                :placeholder="$t('Educational.circulateRegistrat.missclassRecord.placehold')"
                @change="handClickChange(scope.row,scope.$index,tableData.list[scope.$index][column.fieldstring],column)"
                :disabled="column.disabled"
              >
                <el-option
                  :value="0"
                  :label="$t('Educational.circulateRegistrat.missclassRecord.select[0]')"
                ></el-option>
                <el-option
                  :value="1"
                  :label="$t('Educational.circulateRegistrat.missclassRecord.select[1]')"
                ></el-option>
                <el-option
                  :value="-1"
                  :label="$t('Educational.circulateRegistrat.missclassRecord.select[2]')"
                ></el-option>
              </el-select>
...
export default {
  ...
  methods: {
    ...
    handClickChange(row, index, v) {
      this.$emit("handClickChange", row, index, v);
    },
