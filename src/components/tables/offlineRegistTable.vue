<template>
  ...
  <!-- 适用于教务系统 小循环登记 -- 线下登记 -->
  <div
    class="table-content offlineRegistTable"
          ...
          >
            <template slot-scope="scope">
              ...
              <el-input
                ...
                "
                :disabled="column.disabled || tableData.list[scope.$index][column.fieldstring] == '--'"
              ></el-input>
              <el-select
                v-else-if="column.isSelect"
                v-model="scope.row[column.fieldstring]"
                :placeholder="
                  $t('Educational.circulateRegistrat.offlineRegist.placehold')
                "
                @change="
                  handClickChange(
                    scope.row,
              ...
              >
                <el-option
                  :value="1"
                  :label="
                    $t('Educational.circulateRegistrat.offlineRegist.select[0]')
                  "
                ></el-option>
                <el-option
                  :value="0"
                  :label="
                    $t('Educational.circulateRegistrat.offlineRegist.select[1]')
                  "
                ></el-option>
              </el-select>
        ...
        <template v-else>
          ...
          >
            <template slot-scope="scope">
              ...
              <el-select
                v-else-if="column.isSelectHomework"
                v-model="scope.row[column.fieldstring]"
                placeholder="请选择线下作业状态"
                @change="
                  handClickChange(
                    scope.row,
                    scope.$index,
                ...
                "
              >
                <!-- <el-option :value="0" label="无作业"></el-option> -->
