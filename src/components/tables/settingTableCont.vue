<template>
  <!-- 表格说明： 此表格主要用于"系统设置"模块专用表格组件,包括switch开关的样式，同时兼具基本表格的功能：：复选框，编辑列，表格列中内容有点击事件-->
  <div
    class="table-content table-setting-cont"
        ...
        <template v-if="$index==IndexId || $index==IndexIdTwo ||$index==0">
          ...
          >
            <template slot-scope="scope">
              <el-switch
                @change="switchChange(scope, scope.$index)"
                active-value="100"
                inactive-value="0"
                active-color="#F78F0E"
