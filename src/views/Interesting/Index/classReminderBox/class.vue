<template>
  <div class="Interesting-classReminder-class height100">
    <!-- 页面右边按钮***start -->
    <div class="right-btn">
      <el-button
...
export default {
  name: "Interesting-classReminder-class",
  components: {
    remindTableCont,
    popTips
  },
    ...
    return {
      ...
      tableList: {
        ...
        options: {
          ...
          ColumnName: "classReminder_class" //当前页面的名称，通常与路由名称一致
        }
      },
      // 分页
      paging: {
...
<style lang="less">
.Interesting-classReminder-class {
}
</style>
