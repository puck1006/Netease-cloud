<template>
  <div class="Interesting-classReminder-total height100">
    <!-- 页面右边按钮***start -->
    <div class="right-btn">
      <el-button
        v-if="$userDetails.account_class!='1'"
        type="primary"
        size="mini"
        @click="allReadItem = true"
      >
        {{
    ...
    <div class="content-box bg-white flex1 pl12 pr12">
      <div v-if="multipleSelection.length == 0" class="flex-wrap pt12">
        <div class="flex-al mb12">
          <span class="mr10 fs14 color-4C5">{{ $t("Interesting.classReminder.filter_name1") }}：</span>
          <div class="time-box" style="width:260px;">
            <el-date-picker
              ...
              :start-placeholder="$t('Interesting.classReminder.placeholder1[1]')"
        ...
        <div class="flex-al mb12">
          <span class="mr10 fs14 color-4C5">{{ $t("Interesting.classReminder.filter_name2") }}：</span>
        ...
        <div class="lines ml16 mr16 mb12"></div>
        <div class="flex-al mb12">
          <span class="mr10 fs14 color-4C5">{{ $t("Interesting.classReminder.filter_name3") }}：</span>
          <div class="select-box" style="width:170px;">
            <el-select
...
export default {
  name: "Interesting-classReminder-total",
  components: {
    remindTableCont,
    popTips
  },
    ...
    return {
      ...
      tableList: {
        ...
        options: {
          ...
          ColumnName: "classReminder_total" //当前页面的名称，通常与路由名称一致
        }
      },
      // 分页
      paging: {
...
<style lang="less">
.Interesting-classReminder-total {
}
</style>
