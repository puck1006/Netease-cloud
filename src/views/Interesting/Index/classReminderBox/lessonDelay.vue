<template>
  <div class="Interesting-classReminder-lessonDelay height100">
    <!-- 页面右边按钮***start -->
    <!-- <div class="right-btn">
...
export default {
  name: "Interesting-classReminder-lessonDelay",
  components: {
    remindTableCont,
    popTips,
  },
    ...
    return {
      ...
      tableList: {
        ...
        options: {
          ...
          ColumnName: "classReminder_lessonDelay", //当前页面的名称，通常与路由名称一致
        },
      },
      // 分页
      paging: {
...
<style lang="less">
.Interesting-classReminder-lessonDelay {
}
</style>
