<template>
  <div class="Interesting-prepareLessons-processing height100">
    <!-- 页面右边按钮***start -->
...
export default {
  name: "Interesting-prepareLessons-processing",
  components: {
    progressTableCont,
    popTips,
    blank,
    ...
    return {
      ...
      tableList: {
        ...
        options: {
          ...
          ColumnName: "prepareLessons_processing", //当前页面的名称，通常与路由名称一致
        },
      },
      tableListInventory: {
        // 表格的列
    ...
    CoursewareHome() {
      httpApi
        .CoursewareHome({
          ...
          // 筛选条件
          class_status: "1", //班级状态 :0待进行1进行中（不传查全部）
...
<style lang="less">
.Interesting-prepareLessons-processing {
}
</style>
