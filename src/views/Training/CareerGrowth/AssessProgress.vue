...
export default {
  ...
  data() {
    return {
      innerSlider: [
        {
          title: this.$t("Training.AssessProgress.info[0]"),
          module_id: "115",
          postrole_id: null,
          url: `/Training/AssessProgress/InExam?stage_id=${this.$route.query.stage_id}`
        },
        {
          title: this.$t("Training.AssessProgress.info[1]"),
          module_id: "116",
          postrole_id: null,
          url: `/Training/AssessProgress/ExaminationRecord?stage_id=${this.$route.query.stage_id}`
        }
      ]
    };
  },
