<template>
  <div class="Educational-circulateRegistrat height100">
    <div class="flex-all pt10 pb10 pl12 pr12 bg-white height50 bottom-line-f2f7">
      <div class="ct-head-left flex-al">
        ...
        <span class="color-243 fs18">{{$t('Training.OpenClass.info[0]')}}</span>
      </div>
...
<script>
export default {
  name: "Educational-circulateRegistrat",
  data() {
    return {
      innerSlider: [
        {
          title: this.$t('Training.OpenClass.info[1]'),
          module_id: "115",
          postrole_id: null,
          url: "/Training/OpenClass/AllCourseware"
        },
        {
          title: this.$t('Training.OpenClass.info[2]'),
          module_id: "116",
          postrole_id: null,
          url: "/Training/OpenClass/OpenCourse"
        },
        {
          title: this.$t('Training.OpenClass.info[3]'),
          module_id: "117",
          postrole_id: null,
          url: "/Training/OpenClass/PrincipalTraining"
        }
      ]
    };
  },
...
<style lang="less">
.Educational-circulateRegistrat {
}
</style>
