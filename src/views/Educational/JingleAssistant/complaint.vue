<template>
  <div class="Educational-complaint Educational-box">
    <div
    ...
    >
      <div class="ct-head-left flex-al">
        ...
        <span class="color-243 fs18">{{
          $t("Educational.JingleAssistant.complaint.page_title")
        }}</span>
      </div>
    </div>
...
<script>
export default {
  name: "Educational-complaint",
  data() {
    return {
      innerSlider: [
        {
          title: this.$t(
            "Educational.JingleAssistant.complaint.innerSliderArr[0]"
          ),
          module_id: "115",
          postrole_id: null,
          url: "/Educational/JingleAssistant/complaint/schoolComplaint"
        },
        {
          title: this.$t(
            "Educational.JingleAssistant.complaint.innerSliderArr[1]"
          ),
          module_id: "116",
          postrole_id: null,
          url: "/Educational/JingleAssistant/complaint/teacherComplaint"
        }
      ]
    };
  },
