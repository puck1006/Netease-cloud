<template>
  <div class="Educational-checkStatus height100">
    <div class="flex-all pt10 pb10 pl12 pr12 bg-white height50 bottom-line-f2f7">
      <div class="ct-head-left flex-al">
        ...
        <span class="color-243 fs18">{{$t("Educational.circulateRegistrat.my_class")}}</span>
      </div>
      <div class="cr-head-right fs12">
        <span>{{$t("Common.header.nav_name3")}}</span>><span>{{$t("Educational.checkStatusrouter.title")}}</span>><span class="color-blue">{{$t("Educational.circulateRegistrat.my_class")}}</span>
      ...
      innerSlider: [
        {
          ...
          module_id: "115",
          postrole_id: null,
          url: "/Educational/checkStatus/onProgress"
        },
        {
          title: "未开始",
          module_id: "116",
          postrole_id: null,
          url: "/Educational/checkStatus/notStarted"
        },
        {
          title: "全部",
          module_id: "117",
          postrole_id: null,
          url: "/Educational/checkStatus/total"
        }
      ]
    };
  },
