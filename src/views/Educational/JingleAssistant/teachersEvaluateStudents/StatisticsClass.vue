        ...
        <div class="dialog-content">
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane :label="'评价('+evaluate_num + ')'" name="0">
              <ul class="fs12" v-if="CevaluateStateList.length > 0">
                <li class="flex-al mb24" v-for="(item,index) in CevaluateStateList" :key="index">
                  ...
                  <img
                    ...
                    alt
                  />
                  <!-- <img src="@/assets/images/default-new-men.png" v-else alt />s -->
            ...
            <el-tab-pane :label="'回评('+return_num + ')'" name="1">
              <ul class="fs12" v-if="CevaluateStateList.length > 0">
                <li class="flex-al mb24" v-for="(item,index) in CevaluateStateList" :key="index">
                  ...
                  <i class="icon-girl" v-if="item.student_sex == '女'"></i>
                  <i class="icon-boy" v-else></i>
                  <span class="status status_red ml5">回评</span>
                </li>
              </ul>
            </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    curPageChange2(v) {
      ...
      this.handleStafferList(this.col);
    },
    curPageChange(v) {
      this.paging2.curPage = v;
      this.EvaluateHome();
