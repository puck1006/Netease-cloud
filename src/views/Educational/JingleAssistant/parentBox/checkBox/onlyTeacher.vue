<template>
  <div class="Educational-onlyTeacher">
    <!-- 页面右边按钮***end -->
    ...
    return {
      ...
      tableList: {
        ...
        options: {
          ...
          ColumnName: "onlyTeacher" //当前页面的名称，通常与路由名称一致
        }
      },
      // 弹窗表哥
      tableviewDetails: {
    ...
    Attendance() {
      eduHttp
        .Attendance({
          ...
          is_evaluate: this.filter.is_evaluate,
          p: this.paging.curPage,
          num: this.paging.pageSize,
          is_count: "1" //是否需要总数
        })
