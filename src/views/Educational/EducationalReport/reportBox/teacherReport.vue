<template>
  <div class="Educational-report-teacherReport height100">
    <div class="content-box bg-white flex1 pl12 pr12">
      <div class="flex-wrap pt12">
        ...
        <div class="flex-al mb12">
          ...
          >{{ $t("Educational.educationalReport.teacherReport.campus") }}</span>
          <div class="select-box" style="width:170px;">
            <el-select
              v-model="filter.re_school_id"
              clearable
              filterable
              :placeholder="$t('Educational.educationalReport.teacherReport.campus_ph')"
              @change="search"
            >
              <el-option
        ...
        <div class="flex-al Inquire-box mb12">
          <div class="ipt-box" style="width: 240px">
            <el-input
              ...
              clearable
              :placeholder="$t('Educational.educationalReport.teacherReport.find_ph')"
              @clear="search"
          ...
          >
            <template slot-scope="scope">
              <el-button
                ...
                >{{
                  $t("Educational.educationalReport.teacherReport.roomCount")
                }}</el-button
              >
            </template>
          </el-table-column>
...
export default {
  name: "Educational-report-teacherReport",
  components: {
    normalTableCont,
  },
  data() {
    return {
      ...
      tableList: {
        ...
        options: {
          ...
          ColumnName: "report_teacherReport", //当前页面的名称，通常与路由名称一致
        },
      },
      // 分页
      paging: {
  ...
  methods: {
    ...
    handCount(row) {
      console.log(row);
      this.$router.push({
        path: `/Educational/report/classTeacherReport/classReport?staffer_id=${row.staffer_id}&school_id=${row.school_id}&status=1`,
      });
    },
    // 编辑列编辑提交
    handSetting(v) {
...
<style lang="less">
.Educational-report-teacherReport {
}
</style>
