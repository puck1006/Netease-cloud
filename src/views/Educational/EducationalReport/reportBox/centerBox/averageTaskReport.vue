        ...
        <div class="flex-al Inquire-box mb12">
          <div class="ipt-box" style="width: 240px">
            <el-input
              ...
              clearable
              :placeholder="$t('Educational.educationalReport.schoolTaskReport.find_ph')"
              @clear="search"
    ...
    return {
      ...
      tableList: {
        ...
        options: {
          ...
          tableHeight: 0, //表格高度
          moduleName: "averageTaskReport", //当前页面所属于模块的名称****一个模块是唯一的
          ColumnName: "averageTaskReport", //当前页面的名称，通常与路由名称一致
        },
      },
      // 分页
      paging: {
