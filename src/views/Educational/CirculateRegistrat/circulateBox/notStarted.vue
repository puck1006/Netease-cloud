<template>
  <div class="Educational-notStarted">
            ...
            <div v-if="card.status" class="hoverDiv color-white fs14">
              <div class="pos fs12">
                <span class="color-red"
                  >{{ card.hour_diffnum
                  }}{{ $t("Educational.circulateRegistrat.pro1") }}</span
                >
              </div>
              <div class="btnDiv">
    ...
    return {
      ...
      tableList: {
        ...
        options: {
          ...
          ColumnName: "circulate_notStarted", //当前页面的名称，通常与路由名称一致
        },
      },
      // 分页
      paging: {
